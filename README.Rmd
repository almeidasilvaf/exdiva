...
[![GitHub pulls](https://img.shields.io/github/issues-pr/almeidasilvaf/exdiva)](https://github.com/almeidasilvaf/exdiva/pulls)
...
Please note that the `exdiva` was only made possible thanks to many other R and bioinformatics software authors, which are cited either in the vignettes and/or the paper(s) describing this package.
